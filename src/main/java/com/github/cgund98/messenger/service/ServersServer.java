...
import com.github.cgund98.messenger.proto.CreateServerRequest;
import com.github.cgund98.messenger.proto.CreateServerResponse;
import com.github.cgund98.messenger.proto.ServersSvcGrpc;
...
public class ServersServer {
  ...
  public static class ServersSvcImpl extends ServersSvcGrpc.ServersSvcImplBase {
    ...
    public void createServer(
        CreateServerRequest req, StreamObserver<CreateServerResponse> responseObserver) {
      CreateServerResponse response =
          CreateServerResponse.newBuilder()
              .setId(1)
